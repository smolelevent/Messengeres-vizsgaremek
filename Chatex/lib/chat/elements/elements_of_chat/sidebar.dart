...
//   String _language = "English"; // Alapértelmezett nyelv
...
//     String lang = await Preferences.getPreferredLanguage();
//     setState(() {
//       _language = lang;
//     });
//   }
...
//       items: [
//         SidebarXItem(
//           label: _language == "Magyar" ? 'Chatek' : 'Chats',
...
//         ),
//         SidebarXItem(
//           label: _language == "Magyar" ? 'Csoportok' : 'Groups',
//           iconBuilder: (context, isSelected) {
//             return Icon(
//               Icons.group,
//               color: Colors.yellow,
...
//       footerItems: [
//         SidebarXItem(
//           label: _language == "Magyar" ? 'Beállítások' : 'Settings',
//           iconBuilder: (context, isSelected) {
//             return Icon(
//               Icons.settings,
//               color: Colors.blue,
...
//         ),
//         SidebarXItem(
//           label: _language == "Magyar" ? 'Nyelv: $_language' : 'Language: $_language',
//           iconBuilder: (context, isSelected) {
//             return Icon(
//               Icons.language,
//               color: Colors.green,
...
//           },
//           onTap: () async {
//             String newLanguage = _language == "Magyar" ? "English" : "Magyar";
//             await _changeLanguage(newLanguage);
//           },
//         ),
//         SidebarXItem(
//           label: _language == "Magyar" ? "Kijelentkezés" : "Logout",
//           iconBuilder: (context, isSelected) {
//             return Icon(
//               Icons.logout,
//               color: Colors.red,
