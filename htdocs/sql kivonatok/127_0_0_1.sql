...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Feb 06. 23:13
...
--
-- A tábla adatainak kiíratása `pma__column_info`
--
...
(1, 'dbchatex', 'users', 'username', '', 'text_plain', '', '', '', ''),
(2, 'dbchatex', 'users', 'email', '', 'text_plain', '', '', '', ''),
(3, 'dbchatex', 'users', 'password_hash', '', 'text_plain', '', '', '', '');
...
('root', '[{\"db\":\"dbchatex\",\"table\":\"users\"},{\"db\":\"dbchatex\",\"table\":\"userstable\"},{\"db\":\"dbchatex\",\"table\":\"UsersTable\"}]');
...
('root', '2025-02-06 20:59:10', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"hu\",\"DefaultConnectionCollation\":\"utf8mb4_hungarian_ci\",\"ThemeDefault\":\"pmahomme\"}');
